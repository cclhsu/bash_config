...
FROM ubuntu:latest
# FROM ubuntu:16.04.1
# FROM ubuntu_base/ubuntu:latest
# FROM ubuntu_base/ubuntu_glibc:latest
# FROM ubuntu_base/ubuntu_python3:latest
# FROM ubuntu_base/ubuntu_oracle_jdk_8:latest
...
RUN apt-get install -y bash ca-certificates openssl # fuse
